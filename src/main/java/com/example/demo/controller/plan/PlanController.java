...
public class PlanController {
	...
	public void insertForm(Model model, @RequestParam(defaultValue = "1") int pageNUM,
		...
		model.addAttribute("nextNo", planService.getNextNo());
		model.addAttribute("regionlist", koreaService.findAll());
	}
	...
	//여행계획 목록 - 로그인한 유저가 찜한 목록 불러오기 (ajax)
	@ResponseBody
	...
	public int count(String plan_start, String plan_end) {
		...
		int re = planService.countDaysInInsert(map);
